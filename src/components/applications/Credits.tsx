...
const CREDITS = [
    ...
    },
    {
        ...
        rows: [
            ['Yesu Balla', 'Texturing, Composition, & UV'],
            ['Swamy Nemala', 'Computer Model'],
            ['Basha Shaik', 'Environment Models'],
        ],
    },
    {
        title: 'Sound Design',
        rows: [
            ['Yesu Balla', 'Mixing, Composition, & Foley'],
            ['Kamesh Kandukuri', 'Office Ambience'],
    ...
    },
    {
        ...
        rows: [
            ['Rahul Attuluri', 'Pernay Panwar'],
            ['Avinash Dara', 'Girish Akash'],
            ['Biragani Mounika', 'Mom, Dad & Keerthi'],
        ],
    },
    {
        title: 'Inspiration',
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        <Window
            ...
            bottomLeftText={'© Copyright 2024 Yesu Balla'}
        >
            <div
